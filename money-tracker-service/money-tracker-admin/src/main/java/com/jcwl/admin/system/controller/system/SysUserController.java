...
import com.jcwl.common.core.domain.entity.SysDept;
import com.jcwl.common.core.domain.entity.SysRole;
...
import com.jcwl.system.domain.vo.SysUserOptionVO;
import com.jcwl.system.service.ISysDeptService;
import com.jcwl.system.service.ISysPostService;
import com.jcwl.system.service.ISysRoleService;
...
public class SysUserController extends BaseController {
    ...
    @GetMapping("/options")
    @ApiOperation("用户下拉选项")
    public R<List<SysUserOptionVO>> getUserOptions() {
        List<SysUser> userList = userService.selectUserList(new SysUser());
        return R.ok(userList.stream()
                .map(sysUser -> {
                    SysUserOptionVO vo = new SysUserOptionVO(sysUser.getUserId(), sysUser.getNickName());
                    return vo;
                })
