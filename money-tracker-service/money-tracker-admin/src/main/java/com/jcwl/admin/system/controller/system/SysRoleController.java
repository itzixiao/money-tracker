...
import com.jcwl.system.domain.SysUserRole;
...
public class SysRoleController extends BaseController {
    ...
    @PreAuthorize("@ss.hasAnyPermi('system:role:export')")
    @PostMapping("/export")
     ...
     * 修改保存数据权限
     */
    @PreAuthorize("@ss.hasAnyPermi('system:role:data_scope')")
    @Log(title = "角色管理", businessType = BusinessType.UPDATE)
     ...
     * 批量取消授权用户
     */
    @PreAuthorize("@ss.hasAnyPermi('system:role:allot_user')")
    @Log(title = "角色管理", businessType = BusinessType.GRANT)
