...
import com.jcwl.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            // String avatar = FileUploadUtils.upload(JcwlConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
            MinioFile minioFile = minioService.putObject(file);
            String avatar = minioFile.getName();
